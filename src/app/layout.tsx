...
export default function RootLayout({
  ...
  const allMenuItems = [
    ...
    { title: 'Cadastro de Usuários', icon: <UserCog size={18} />, path: '/usuarios', roles: ['SUPER_ADMIN', 'ADMINISTRADORA'] },
    ...
    { title: (user?.role === 'MORADOR') ? 'Solicitação de Reparos' : 'Tarefas', icon: <ListTodo size={18} />, path: '/tarefas', roles: ['SUPER_ADMIN', 'SINDICO', 'MORADOR', 'CONSELHO'] },
