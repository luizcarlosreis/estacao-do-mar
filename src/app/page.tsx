...
export default function Home() {
  ...
  const allModules = [
    ...
    { title: 'Boleto (2a. via)', icon: <FileText size={16} />, path: '/teste-boleto', desc: 'Emissão de segunda via de boletos via Winker.', roles: ['SUPER_ADMIN', 'MORADOR', 'ADMINISTRADORA'], color: 'text-rose-600', bg: 'bg-rose-50' },
