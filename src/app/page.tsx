...
export default function Home() {
  ...
  const allModules = [
    ...
    { title: 'Teste de Boleto', icon: <FileText size={16} />, path: '/teste-boleto', desc: 'Impressão de boleto para teste via API.', roles: ['SUPER_ADMIN'], color: 'text-rose-600', bg: 'bg-rose-50' },
