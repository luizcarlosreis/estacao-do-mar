...
export default function Home() {
  ...
  const allModules = [
    ...
    { title: 'Salão de Festas', icon: <Calendar size={16} />, path: '/reservas', desc: 'Solicitações de reserva do salão.', roles: ['SUPER_ADMIN', 'SINDICO', 'MORADOR'], color: 'text-blue-600', bg: 'bg-blue-50' },
